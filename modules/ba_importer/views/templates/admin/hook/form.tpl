        ...
        <h3>{l s='Upload Excel File' mod='ba_importer'}</h3>
            ...
            <div class="form-group">
                ...
                <select class="import_items" name="new_items">
                    ...
                    <option value='Ignore' {if $arr_confign_bc1.new_items == 'Ignore'}selected{/if}>{l s='Ignore' mod='ba_importer'}</option>
										...
										<!-- // MOD 087.5: Add additional "new_items" option. -->
										<option value='IgnoreAndEmail' {if $arr_confign_bc1.new_items == 'IgnoreAndEmail'}selected{/if}>{l s='Ignore & Email' mod='ba_importer'}</option>
										<!-- // MOD 087.5 END -->
            ...
            <div class="form-group">
                ...
                <select class="import_items" name="identify_existing_items_combi">
                    ...
                    <option value='Combi Reference code' {if $arr_confign_bc1.identify_existing_items_combi == 'Combi Reference code'}selected{/if}>{l s='Reference code' mod='ba_importer'}</option>

                    <option value='Combi EAN-13 or JAN barcode' {if $arr_confign_bc1.identify_existing_items_combi == 'Combi EAN-13 or JAN barcode'}selected{/if}>{l s='EAN-13 or JAN barcode' mod='ba_importer'}</option>

                    <option value='Combi UPC barcode' {if $arr_confign_bc1.identify_existing_items_combi == 'Combi UPC barcode'}selected{/if}>{l s='UPC barcode' mod='ba_importer'}</option>
